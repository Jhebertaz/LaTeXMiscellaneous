...
##########################################################
    with open('database.csv','a') as csvfile:
        writer=csv.writer(csvfile)
        writer.writerow([aBillNumber,aFirstName,aSurname,aAddress1,aCity1,aAddress2,aCity2,aObject,aDate,\
                        aRow1,aRow11,aRow2,aRow12,aRow3,aRow13,aRow4,aRow14,aRow5,aRow15,aRow6,aRow16,aRow7,aRow17])
        csvfile.close()
#############
## Back up ##
...
entryEmail      = Entry(root, textvariable = Email, width = 21).grid(row = 4,column=1 ,columnspan = 2)
################
## Address1 ##
################
